    ...
    return (
        ...
        <div className={styles.popup}>
            ...
            <div className={styles.containerDescPhrase}>
                <h1><span>desculpe, mas</span></h1>
                <h2>esta página não existe</h2>
            </div>
            <div className={styles.footer}>
                <a className={styles.buttonPrimary} onClick={handleBack}><span>Voltar</span></a>
                <a className={styles.buttonSecundary} href="/"><span>Home</span></a>
            </div>
        </div>
