      ...
      {createdUser ? (
        <div className={styles.container}>
          ...
          <div className={styles.userInfo}>
            <p>
              <strong>Nome Completo:</strong> {createdUser.name}{" "}
        ...
        <div className={styles.container}>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className={styles.form}>
            ...
            <label htmlFor="auth" className={styles.label}>
              <span>Usuário: <span className="text-red-400">&lowast;</span></span>
              <input
                type="text"
                {...register("username")}
                className={styles.input}
            ...
            <label htmlFor="auth" className={styles.label}>
              <span>Email: <span className="text-red-400">&lowast;</span></span>
              <input
                type="email"
